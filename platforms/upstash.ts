...
import {
  ...
  RedisConfigDeno,
} from "https://deno.land/x/upstash_redis@v1.18.5/mod.ts";
import { AbstractResourceType, ResourceObject } from "../core/resource.ts";
import { isPrimitive, isQuantity, Quantity } from "../core/query.ts";
...
export class Redis extends StorageAdapter<
  { root: string; field: string },
  Promise<string[]>
> {
